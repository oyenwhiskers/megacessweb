...
// ==============================================
// Change ENV to switch between environments: 'local', 'staging' or 'production'

const ENV = 'local'; // CHANGE THIS TO SWITCH ENVIRONMENTS
...
// This ensures local uses local storage, staging uses staging storage and production uses production storage
